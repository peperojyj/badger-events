...
function EventListPage() {
  ...
  const [draftKeyword, setDraftKeyword] =
    useState('')
  ...
  }, [submittedKeyword, requestVersion])
      ...
      <section className="hero">
        <div className="hero__inner">
          ...
          <p className="hero__lede">
            ...
            campus today, this week, and beyond.
          </p>
        ...
        {!loading &&
          ...
          events.length === 0 && (
            <StatusPanel
              ...
              message={
                'Try a broader keyword or clear ' +
                'the search to see every event.'
              }
              action={
                submittedKeyword ? (
                  <button
